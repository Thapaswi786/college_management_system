  ...
  return (
    <main className="page">
      ...
      <section className="section-block">
        ...
        <p className="section-subtitle">
          A modern campus built to inspire learning, innovation, and collaboration.
        </p>
        <div className="grid-3">
          <div className="content-card">
      ...
      <section className="section-block">
        ...
        <div className="grid-3">
          {[
            { name: "Dr. Albus Dumbledore", role: "Chairman & Founder", desc: "PhD in Computer Science, IIT Madras. 35+ years in academia and research." },
            { name: "Dr. Minerva McGonagall", role: "Principal", desc: "PhD in Electronics, NIT Trichy. Recipient of Best Principal Award – Tamil Nadu 2022." },
            { name: "Prof. Severus Snape", role: "Dean – Academics", desc: "M.Tech from IIT Bombay. 28 years of teaching and curriculum development experience." },
          ].map((leader) => (
